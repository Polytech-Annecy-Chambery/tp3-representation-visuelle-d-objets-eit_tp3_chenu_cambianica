...
def Q5a():  
    ...
    opening1 = Opening({'position': [2, 0, 0], 'width':0.9, 'height':2.15, 'thick':0.2, 'color': [0.7, 0.7, 0.7]})
    opening2 = Opening({'position': [4, 0, 1.2], 'width':1.25, 'height':1, 'thick':0.2, 'color': [0.7, 0.7, 0.7]})    
...
def Q5b():  
    ...
    opening1 = Opening({'position': [2, 0, 0], 'width':0.9, 'height':2.15, 'thick':0.2, 'color': [0.7, 0.7, 0.7]})
    opening2 = Opening({'position': [4, 0, 1.2], 'width':1.25, 'height':1, 'thick':0.2, 'color': [0.7, 0.7, 0.7]}) 
    opening3 = Opening({'position': [4, 0, 1.7], 'width':1.25, 'height':1, 'thick':0.2, 'color': [0.7, 0.7, 0.7]}) 
